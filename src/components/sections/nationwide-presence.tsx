...
const NationwidePresence: React.FC = () => {
    return (
        <section
            className="relative w-full h-120 sm:h-130 py-20 px-4 sm:py-24 md:py-32 flex flex-col items-center justify-center overflow-hidden"
            style={{
                // A radial or linear gradient as seen in the screenshots
                background:
                    "linear-gradient(135deg, #7A7A7A 0%, #5C5C5C 50%, #7A7A7A 100%)",
            }}
        >
            <div className="max-w-360 min-h-104 text-center z-10 ">
                {/* Main Heading */}
                ...
                <div
                    className="w-48 sm:w-64 h-1 mx-auto mb-10 rounded-full"
                    style={{
                        background:
                            "linear-gradient(to right, #F2913F, #F2913F, #1E3A8A)",
                    }}
                ></div>
