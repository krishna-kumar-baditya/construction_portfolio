...
const NAV_LINKS = [
  ...
  },
  {
    ...
    href: "/companies",
    dropdown: [
      { label: "EVERGREEN MANAGEMENT CONSULTANTS LLP", href: "/companies/emcl" },
      { label: "EVERGREEN CONSTRUCTION DURGAPUR PVT. LTD.", href: "/companies/ecpl" },
    ],
  },
              ...
              >
                ...
                /> */}
                  <div className="flex flex-col">
                    <span className={`text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-none transition-colors duration-300 ${
                      isScrolled ? "text-gray-900" : "text-white"
                    }`} style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic" }}>
                      Evergreen Group
                    </span>
                    <span className="text-[10px] md:text-xs font-bold tracking-wider uppercase mt-1 text-[#F2913F]" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic" }}>
                      Of Companies
                    </span>
                  </div>
              </a>
