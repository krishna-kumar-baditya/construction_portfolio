          ...
          <section id="leadership" className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Our Leadership</h2>
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Guided by industry veterans with a passion for excellence and a vision for the future.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                {[
                  { name: "S. K. Gupta", role: "Managing Partner", img: "https://i.pravatar.cc/300?u=sk" },
                  { name: "Anita Rao", role: "Technical Director", img: "https://i.pravatar.cc/300?u=ar" },
                  { name: "Rahul Sharma", role: "Head of Operations", img: "https://i.pravatar.cc/300?u=rs" }
                ].map((member, i) => (
                  <motion.div
                    key={member.name}
                  ...
                  >
                    <div className="aspect-[3/4] rounded-2xl overflow-hidden mb-6 relative">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                        <p className="text-white font-medium">Over 20 years of experience in infrastructure management.</p>
                      </div>
                    </div>
                    <h4 className="text-2xl font-bold text-gray-900">{member.name}</h4>
                    <p className="text-[#F2913F] font-bold uppercase tracking-wider text-sm">{member.role}</p>
                  </motion.div>
                ))}
              </div>
            </div>
                ...
                <div className="p-12 md:p-20">
                  ...
                  <h3 className="text-4xl font-extrabold text-gray-900 mb-6">
                    ...
                    <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                      At Evergreen, sustainability is not just a buzzword; it's the core of our engineering philosophy. We prioritize eco-friendly materials, energy-efficient designs, and construction practices that minimize environmental impact.
                    </p>
                  <ul className="space-y-4">
                    {["Green Building Practices", "Renewable Energy Integration", "Waste Management Solutions", "Eco-friendly Materials"].map((item) => (
