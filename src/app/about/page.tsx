          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-10 mt-10">
              ...
              <div className="md:col-span-2">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-[#0B1B3A] mb-4">
                  Over 50 Years of Supplying Strength
                </h3>

                <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
                  Since 1988, Evergreen Group of Companies has been a trusted name
                  in infrastructure and industrial solutions across Eastern India.
                </p>

                <p className="text-gray-700 leading-relaxed text-base sm:text-lg mt-4">
                  We serve infrastructure projects, government bodies, MSMEs,
                  and heavy industries with a strong commitment to quality,
                  integrity, and timely delivery.
                </p>
              </div>

              <div className="w-full h-56 sm:h-64 md:h-[250px] overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1492724441997-5dc865305da7?q=80&w=800&auto=format&fit=crop"
                  alt="Corporate Environment"
                  className="w-full h-full object-cover"
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-gray-700 text-base sm:text-lg max-w-3xl leading-relaxed mb-12">
              From planning to execution, Evergreen focuses on long-term relationships
              through quality delivery and operational excellence.
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
              {[
                ...
                <div
                  key={item}
                  className="bg-[#0B1B3A] text-white p-8 sm:p-10 flex items-center justify-center text-center h-36 sm:h-44"
                >
                  <h3 className="text-sm text-white sm:text-base font-semibold leading-relaxed">
                    {item}
                  </h3>
                </div>
              ))}
            ...
            <div className="text-center max-w-4xl mx-auto text-gray-800 text-base sm:text-lg leading-relaxed">
              ...
              <p>
                We don’t just execute projects — we deliver reliability and long-term partnerships.
              </p>
            </div>
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="relative md:absolute md:left-0 md:top-77.5 md:w-2/3 bg-[#BFD6EA] p-6 sm:p-10 mt-6 md:mt-0">
              ...
              <p className="text-gray-800 text-sm sm:text-lg leading-relaxed">
                We look forward to being a reliable partner in your growth.
              </p>
            </div>
