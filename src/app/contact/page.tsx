                ...
                <section className="bg-black py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                            Have a project in mind or need expert consulting?
                            ...
                            >
                                ...
                                <div className="space-y-10">
                                    <div className="flex gap-6">
                                        <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-[#F2913F] `shrink-0`">
                                            <MapPin size={28} />
                                        </div>
                                        <div>
                                ...
                                {status === "success" ? (
                                    <div className="text-center py-20">
                                        ...
                                        <p className="text-gray-600 mb-8">
                                            Thank you for reaching out. One of
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-black text-white py-6 rounded-2xl font-black text-xl hover:bg-[#F2913F] transition-all duration-300 flex items-center justify-center gap-3 shadow-xl disabled:opacity-50 group"
                                        >
                                            {status === "loading"
                                                ? "Sending..."
                                                : "Send Message"}
