                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 text-justify items-center">
                            ...
                            >
                                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                    ...
                                    requirements. We manufacture a wide range of
                                    concrete products, including: Standard Grade
                                    RMC (M20 to M40), High Strength Concrete
                                    (M45 and above), Self-Compacting Concrete
                                    (SCC) & Fibre Reinforced Concrete (FRC). Our
                                    advanced infrastructure includes a Schwing
                                    Stetter batching plant and concrete pumps,
                                    modern transit mixers, high-capacity cement
                                    silos, a state-of-the-art quality control
                                    laboratory, and an Essae weighbridge for
                                    precise material measurement. With modern
                                    equipment, strict quality testing, and
                                    efficient logistics, we are recognized as a
                                    reliable RMC supplier in Kolkata, delivering
                                    durable and high-performance concrete
                                    solutions.
                                </p>
                            </motion.div>
                            <div className="relative">
                                <div className="h-125 rounded-2xl overflow-hidden shadow-2xl">
                                    <img
